...
```
livepeer.exe -network arbitrum-one-mainnet -ethUrl=<YOUR ARB RPC> ^
-serviceAddr=<YOUR BROADCASTER PUBLIC IP ADDRESS>:8935 -broadcaster ^
-ethPassword=<YOUR PASSWORD>-maxPricePerUnit=300 -monitor -v=6 ^
-rtmpAddr=0.0.0.0:1935 -httpAddr=0.0.0.0:8935 -blockPollingInterval 20 ^
